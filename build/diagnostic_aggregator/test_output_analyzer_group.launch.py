...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, launch_service, proc_info, proc_output):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/mewert/Desktop/luna/diagnostics/diagnostic_aggregator/test/expected_output/output_analyzer_group"),
